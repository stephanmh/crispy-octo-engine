#!groovy
        ...
        step([$class: 'hudson.plugins.sonar.SonarRunnerBuilder', sonar: [projectKey: 'kk-testproj-key', projectName: 'KK-Demo', sources: 'src/'], jdk: '(Inherit From Job)', plugin: 'sonar@2.4' ])
        }
